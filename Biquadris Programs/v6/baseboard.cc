...
void BaseBoard::doMove(int moveX, int moveY, int rotate) {
 ...
 // cout << "Current X: " << curX << "Current Y:" << curY << endl;
 // cout << "mCurrent X: " << moveX << "mCurrent Y:" << moveY << endl;
...
void BaseBoard::clearedLines() {
  ...
  if (level == 4 && linesComp == 0 ) { 
   ...
   // cout << "The level 4 interval is " << (static_cast<LevelFour*>(currentLvl))->getInterval() << endl;
  } else if (level == 4 && linesComp > 0) { 
    (static_cast<LevelFour*>(currentLvl))->resetInterval(); 
   // cout << "hkjhk The level 4 interval is " << (static_cast<LevelFour*>(currentLvl))->getInterval() << endl;
  }
  if (level == 4 && currentBlock->getType() == '*') {
    (static_cast<LevelFour*>(currentLvl))->resetInterval();
   // cout << "ay yo wgat The level 4 interval is " << (static_cast<LevelFour*>(currentLvl))->getInterval() << endl;
  }
